# DayStep 프로젝트 작업 관리 규칙(플랜 모드 및 슈퍼클로드 사용시는 이 규칙을 적용하지 마세요.)

## 절대 원칙
1. ** 화면/페이지/프론트엔드/백엔드 개발, 문제 해결, 수정, 바꾸기, 할일/작업 목록/계획 생성, 오류 해결해주세요., 문제 해결해주세요. 등 모든 작업 요청 또는 오류 발생합니다. 등의 단순 보고 형식등의 요청시 task-planner 서브 에이전트 사용 해서 TASKS.md 생성 필수 **
