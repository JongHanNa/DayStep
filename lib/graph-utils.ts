...
export function areaToGraphNode(area: AreaResource): GraphNode {
  return {
    ...
    type: 'area',
    title: area.title,
    color: area.color || NODE_TYPE_COLORS.area,
...
export function resourceToGraphNode(resource: AreaResource): GraphNode {
  return {
    ...
    color: resource.color || NODE_TYPE_COLORS.resource,
...
export function goalToGraphNode(goal: Goal): GraphNode {
  return {
    ...
    type: 'goal',
    title: goal.title,
    color: goal.color || NODE_TYPE_COLORS.goal,
...
export function projectToGraphNode(project: Project): GraphNode {
  return {
    ...
    type: 'project',
    title: project.title,
    color: project.color || NODE_TYPE_COLORS.project,
...
export function todoToGraphNode(todo: Todo): GraphNode {
  return {
    ...
    type: 'todo',
    title: todo.title,
    color: todo.color ?? NODE_TYPE_COLORS.todo,
