...
function MonthDayCell({
  ...
  return (
    ...
    >
        ...
        <div
          ...
          style={{
            ...
            width: segmentPosition === 'first' || segmentPosition === 'single'
              ...
              : segmentPosition === 'middle'
              ? `calc(${spanDays * 100}% + ${(spanDays - 1) * 0.25}rem + 0.75rem)`
              : `calc(${spanDays * 100}% + ${(spanDays - 1) * 0.25}rem)`,
            zIndex: 1
          }}
        >
      ...
      {/* 할일 목록 */}
      <div className="space-y-1 max-h-[calc(100%-24px)] overflow-y-auto" style={{ marginTop: (spanningCard || hasSpanningCard) ? '60px' : '0' }}>
        {todos.map((todo) => {
