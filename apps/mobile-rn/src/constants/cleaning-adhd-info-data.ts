...
export const CLEANING_HERO_DATA = {
  ...
  title: '왜 ADHD인에게\n청소 시작이 유독 어려울까요',
  intro:
    'ADHD 뇌는 실행기능 장애, 도파민 보상 부재, 감각 과부하라는 삼중 장벽 때문에 청소를 시작하는 것 자체가 일반인과는 차원이 다른 난이도입니다. 이 글에서는 그 이유와 DayStep의 접근법을 설명합니다.',
};
...
export const ENERGY_MANAGEMENT_DATA: InfoSection = {
  ...
  paragraphs: [
    ...
    'DayStep은 에너지를 좋음/보통/힘듦 3단계로 나누고, 각 단계에 맞는 태스크 양을 자동으로 조절합니다. 에너지가 낮은 날에는 가장 간단한 2~3개 태스크만 보여주고, 좋은 날에는 더 많은 태스크를 제안해요.',
...
export const ROUTINE_AUTOMATION_DATA = {
  ...
  keyMessage:
    'DayStep은 요일별로 구역을 자동 배정하고, 공간/디지털/물건 3탭으로 분류하여 "오늘 뭘 해야 하지?"라는 의사결정 자체를 제거합니다. 앱을 열면 오늘 해야 할 것이 이미 정해져 있어요.',
