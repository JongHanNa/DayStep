 ...
 *
 * APP_FEATURES_MARKETING.md 기반 DayStep 앱 마케팅 레퍼런스
...
const TAGLINE = 'DayStep — ADHD 친화적 일상 케어 시스템';
const ONE_LINER =
