...
// NativeSleepGarden — 수면 정원 4-뷰 ObjC Bridge

@interface RCT_EXTERN_MODULE(NativeSleepGardenManager, RCTViewManager)
...
RCT_EXPORT_VIEW_PROPERTY(goalMinutes, NSNumber)
RCT_EXPORT_VIEW_PROPERTY(streak, NSNumber)
