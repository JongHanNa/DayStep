  ...
  ...(isWebBuild && {
    async redirects() {
      return [
        ...
        { source: '/adhd/project/ai-plan', destination: '/adhd/projects', permanent: true },
        { source: '/adhd/ai-plan', destination: '/adhd/projects', permanent: true },
        { source: '/adhd/project/projects', destination: '/adhd/projects', permanent: true },
